...
RUN conda update -n base conda && \
    conda install -q -y scikit-learn scipy pandas numpy seaborn matplotlib IPython dask dask-ml
...
CMD ["start-notebook.sh", "--NotebookApp.token=", "--NotebookApp.max_buffer_size=2147483648"]
